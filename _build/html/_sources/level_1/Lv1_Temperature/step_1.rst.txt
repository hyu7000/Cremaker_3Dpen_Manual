...
| :yellowcircle:`●` 이어서 변수 추가 버튼을 눌러줍니다.
...
|
| :yellowcircle:`●` 여기에서 :blackbold:`온도센서 신호 값` 블록을 :blackbold:`신호 값 를 10 (으)로 정하기` 블록에 숫자 10 부분에 위치시킵니다.
| :blackcircle:`●` 이 신호 값은 아날로그 신호로 받아옵니다. 최소 0에서 최대 1023까지 받아 올 수 있습니다.
| :blackcircle:`●` 신호값을 확인하고 표를 확인하여 현재 온도가 몇 인지 확인합니다.
|
|
