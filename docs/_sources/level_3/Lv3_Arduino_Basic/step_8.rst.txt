...
| 함수는 프로그래밍 코드가 복잡해 질수록 중요도가 높아집니다.
...
.. _targetL3C6S7_2_2 to paragraph:
...
|
| int 형 변수 c,d,e가 각각 :hoverxref:`선언 <hoverxref:declaration>` 과 초기화되어 있는 상태입니다. e변수에 :blackbold:`더하기(c,d)` 함수가 적혀있습니다. 
